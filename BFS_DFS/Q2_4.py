"""
Q2:
Label the vertices of the graph in the order that they might be visited by a depth-first search, and by a 
breath-first search, from the source s
                    ...
                    |----> b ---->  d      f <---- h
           Ans:
            BFS = s, a, b , c, d , e , g , h , f  
            DFS 1st = s, a, c, e, g, h, f, b, d     
            DFS 2nd = s, b, d, e, g, h, f, a, c

Q4:
Write psuedocode for an algorithm that given a directed graph and a source vertex, returns a list of all
the vertices reachable in the graph from that source vertex. Your algorithm should run in O(V+E) time.
"""
